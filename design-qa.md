...
8. Fourth refinement switched to Saira Condensed and split each number into two glyph spans. Completed nodes now clip the lower-right of the final glyph before positioning the check, matching the source construction instead of overlaying a detached icon.
